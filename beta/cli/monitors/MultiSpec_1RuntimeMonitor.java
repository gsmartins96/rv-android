...
class MessageDigestSpecMonitor extends com.runtimeverification.rvmonitor.java.rt.tablebase.AbstractAtomicMonitor implements Cloneable, com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	static final int Prop_1_transition_g3[] = {3, 4, 4, 4, 4};;
	...
	static final int Prop_1_transition_d1[] = {4, 2, 4, 4, 4};;
	static final int Prop_1_transition_d2[] = {4, 2, 2, 2, 4};;
	static final int Prop_1_transition_d3[] = {4, 2, 4, 4, 4};;
	...
	final boolean Prop_1_event_g1(String alg, MessageDigest digest) {
		...
		this.MessageDigestSpecMonitor_Prop_1_Category_match = nextstate == 2;
